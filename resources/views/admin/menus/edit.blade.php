    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                @endif
                <form id="submit_menu_form" action="{{action('MenuController@update', ['id' => $menu->id])}}" method="POST">
                  {{csrf_field()}}
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <ul id="sortable" class="connectedSortable editMenu" data-url="{{action('MenuController@getJson', ['id' => $menu->id])}}"></ul>
                    </div>
                  </div>                 
                </div>
            </div>
